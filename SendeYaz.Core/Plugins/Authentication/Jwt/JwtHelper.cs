...
namespace SendeYaz.Core.Plugins.Authentication.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(int accountId,List<AccountRulesModel> rules)
        {
        ...
        private JwtSecurityToken CreateJwtSecurityToken(JwtOptions tokenOptions,int accountId,SigningCredentials signingCredentials,List<AccountRulesModel> rules)
        {
        ...
        private static IEnumerable<Claim> SetClaims(int accountId,List<AccountRulesModel> roles)
        {
